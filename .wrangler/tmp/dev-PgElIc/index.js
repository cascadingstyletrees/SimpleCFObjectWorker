...
// .wrangler/tmp/bundle-eUlep7/checked-fetch.js
...
// .wrangler/tmp/bundle-eUlep7/strip-cf-connecting-ip-header.js
...
var html = /* @__PURE__ */ __name((headers, cf) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="container">
    ...
    <div class="grid">
      ...
      <!-- Headers -->
      <div class="card">
        <h2><span>\u{1F4E8}</span> Request Headers</h2>
      ...
      <div class="card">
        <h2><span>\u{1F575}\uFE0F</span> Client-Side Fingerprint</h2>
...
app.all("/status/:code", (c) => {
  ...
  return c.text(`Returned status: ${code}`, code);
});
...
// .wrangler/tmp/bundle-eUlep7/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eUlep7/middleware-loader.entry.ts
