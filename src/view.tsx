...
const Card = ({ title, icon, description, children, className = "" }: { title: string, icon: string, description?: string, children: any, className?: string }) => {
  return (
    <div class={`bg-gray-900 border border-gray-800 rounded-xl overflow-hidden shadow-lg flex flex-col ${className}`}>
  ...
  return (
    <Layout title="Cloudflare Request Inspector">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 items-start">
        ...
        {/* Headers */}
        <Card title="Request Headers" icon="📨" description="HTTP headers sent by your client">
              ...
              <tbody>
                {Object.entries(props.headers).map(([key, value]) => (
                  <tr class="border-b border-gray-800 last:border-0 hover:bg-white/5 transition-colors group">
                    <td class="py-2 px-4 font-mono text-orange-400/90 break-all align-top text-xs md:text-sm">{key}</td>
                    <td class="py-2 px-4 text-gray-300 break-all align-top font-mono text-xs md:text-sm">{value}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <Card title="Client Fingerprint" icon="🕵️" description="Browser signals gathered via JS">
          <div class="p-0">
             <table class="w-full text-sm text-left border-collapse" id="fingerprint-table">
              <tbody>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Screen Res</th><td id="fp-screen" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Color Depth</th><td id="fp-depth" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Timezone</th><td id="fp-tz" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Language</th><td id="fp-lang" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Platform</th><td id="fp-platform" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Hardware</th><td id="fp-cores" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Memory</th><td id="fp-memory" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Touch</th><td id="fp-touch" class="py-2 px-4 text-gray-200">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">Canvas Hash</th><td id="fp-canvas" class="py-2 px-4 text-gray-200 font-mono text-xs">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">WebGL</th><td id="fp-webgl" class="py-2 px-4 text-gray-200 text-xs">...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">FingerprintJS</th><td id="fp-fingerprintjs" class="py-2 px-4 text-orange-400 font-mono text-xs break-all">Loading...</td></tr>
                <tr class="border-b border-gray-800 hover:bg-white/5"><th class="py-2 px-4 text-gray-400 font-medium">ThumbmarkJS</th><td id="fp-thumbmarkjs" class="py-2 px-4 text-orange-400 font-mono text-xs break-all">Loading...</td></tr>
              </tbody>
            </table>
